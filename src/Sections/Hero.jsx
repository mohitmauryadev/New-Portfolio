...
import './Hero.css'
// import profille_img from '../assets/Logos/profille_img.png'
import heroBG from '../assets/Project_img/heroBG.jpg'
...
const Hero = () => {
  ...
  useEffect(() => {
    const text = "Welcome to My Portfolio Nexovate !";
    let index = 0;
    ...
    <div id="home" className='hero' style={SEStyle}>
      <div className='section flex  h-[500px] '>
        ...
        <div className='textar flex flex-col text-center items-center justify-center w-[60%]  p-6'>
            ...
            {/* Aoutowritter */}
            <h1 className="text-white text-2xl font-bold mb-5" ref={typewriterRef}></h1>

            <h3 className='font-bold text-xl text-white'>Hello</h3>
            <h2 className='text-2xl font-bold mb-3 text-white'>I'm <span className='text-green-600 '>Mohit Maurya</span></h2>
