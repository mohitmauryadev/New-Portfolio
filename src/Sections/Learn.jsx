    ...
    return (
        <div id="skills" className="relative top-24 flex flex-wrap justify-center items-center mt-5 mb-24 gap-14">
            ...
            <div
                ...
                {/* Tailwindcss  card */}
                <div className="skillCards flex flex-col justify-center items-center w-[300px] h-[200px] rounded-3xl">
                    <img src={Tailwind} className="relative top-[-25px] w-[50px] h-[60px] p-[5px] rounded-[50%] bg-white" />
                    <div className="flex flex-col justify-center items-center text-center">
                        <h1 className="Htext text-2xl font-bold">Tailwind CSS 🌬 </h1>
                        <p className="Ptext">Utility-first CSS framework expertise for rapid UI development and custom component styling.
                 ...
                 {/* React  card */}
                <div className="skillCards flex flex-col justify-center items-center w-[300px] h-[200px] rounded-3xl">
                    <img src={react} className="relative top-[-25px] w-[50px] h-[60px] p-[5px] rounded-[50%] bg-white" />
                    <div className="flex flex-col justify-center items-center text-center">
                        <h1 className="Htext text-2xl font-bold">React.js ⚛ </h1>
                        <p className="Ptext">Strong in building dynamic, component-based SPA using React hooks and context API.
                        </p>
                    </div>
                </div>
                 ...
                 {/* Node.js  card */}
                <div className="skillCards flex flex-col justify-center items-center w-[300px] h-[200px] rounded-3xl">
                    <img src={nodejs} className="relative top-[-25px] w-[50px] h-[60px] p-[5px] rounded-[50%] bg-white" />
                    <div className="flex flex-col justify-center items-center text-center">
                        <h1 className="Htext text-2xl font-bold">Node.js 🟩 </h1>
                        <p className="Ptext">Asynchronous backend logic and API development using event-driven Node.js runtime.
                        </p>
                    </div>
                </div>
                 ...
                 {/* Express.js  card */}
                <div className="skillCards flex flex-col justify-center items-center w-[300px] h-[200px] rounded-3xl">
                    <img src={express} className="relative top-[-25px] w-[50px] h-[60px] p-[5px] rounded-[50%] bg-white" />
                    <div className="flex flex-col justify-center items-center text-center">
                        <h1 className="Htext text-2xl font-bold">Express.js 🚂 </h1>
                        <p className="Ptext">RESTful API and middleware handling with Express for scalable web applications.
                        </p>
                    </div>
                </div>
                  ...
                  {/* MongoDB  card */}
                <div className="skillCards flex flex-col justify-center items-center w-[300px] h-[200px] rounded-3xl">
                    <img src={MongoDB} className="relative top-[-25px] w-[50px] h-[60px] p-[5px] rounded-[50%] bg-white" />
                    <div className="flex flex-col justify-center items-center text-center">
                        <h1 className="Htext text-2xl font-bold">MongoDB 🍃 </h1>
                        <p className="Ptext">NoSQL database design, queries, and integration in MERN stack applications.
                        </p>
                    </div>
                </div>
