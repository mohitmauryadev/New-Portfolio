  ...
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-300">
            I'm Mohit Maurya, a passionate web and app developer. I love creating modern, fast, and user-friendly digital experiences.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-300">Email: mohitmauryabbdu@gmail.com</p>
   ...
   {/* Bottom Line */}
      <div className="border-t border-gray-700 mt-12 pt-6 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} Mohit Maurya. All rights reserved.
      </div>
    </footer>
  );
};
